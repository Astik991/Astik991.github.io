...
function display_Image(){
    function display_img(image) {
        document.getElementById("image").src = image.message;
      ...
      .then((completedata1) => {
        display_img(completedata1)
      });
}
setInterval(display_Image, 30000)